...
export const PinContainer = ({
    ...
    const handleClick = () => {
        if (!isClicked) { setTransform("translate(-50%,-50%) rotateX(40deg) scale(0.8)") }
        else {
            ...
            <div className=" w-full h-full -mt-7 flex-none  inset-0">
                <div className="absolute top-0 inset-x-0  flex justify-center">
                    <a
                        href={href}
                        target={"_blank"}
                        className="relative flex space-x-2 items-center z-[999] rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 "
                    >
